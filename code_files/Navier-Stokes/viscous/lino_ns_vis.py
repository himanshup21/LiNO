...
N_FIELDS    = 4
data_path = "/home/phimanshu/SSD/Shared/SP_HP_shared/Data/CFD/2D_CFD_Rand_M0.1_Eta0.01_Zeta0.01_periodic_128_Train.hdf5"
...
train_loader = DataLoader(TensorDataset(u_train), batch_size=32, shuffle=True)
...
def model_eval(epoch, loss, t0=t0, inference=False):
    ...
    with torch.no_grad():
        for i in range(n_samples):
            ...
            pred_rho = pred_seq[:, DENSITY_IDX] * rho_std + rho_mean   
